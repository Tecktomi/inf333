...
function crear_juegos()
{
	...
	draw_text(100, 32*control.N_interfaz + 64, "Tranquilidad :" + string_repeat("x ", floor(control.tranquilidad/10) ));
	...
	if ( glob_flag == true ) { control.sigilo -= 0.2; }
	else                     { control.sigilo += 0.002; }
	...
	control.tiempo -= 1 / room_speed;
	
	if ( instance_number(obj_muro)==0 ) { return inicio }
